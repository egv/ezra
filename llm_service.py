...
Just return a single bullet point like: • Brief summary of the main topic"""
                ...
                import re
                summary = re.sub(r'^•\s*', '', summary)  # Remove bullet if LLM added it
                summary = summary.strip()
                
                # Add source link to the summary
                if message_link:
                    digest_items.append(f"• {summary} ([source]({message_link}))")
                else:
            ...
            footer = f"\n\n---\n_Generated by Ezra Bot • {selected_count} most important from {total_messages} messages_"
